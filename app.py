...
def word_para_pdf(files: List[UploadFile] = File(...)):
    try:
        ...
        for caminho in caminhos:
            ...
            print("[LibreOffice] STDOUT:", resultado.stdout.decode())
            print("[LibreOffice] STDERR:", resultado.stderr.decode())
        ...
        print("Erro em /word-para-pdf:", str(e))
...
def pdf_para_jpg(file: UploadFile = File(...)):
    try:
        ...
        print("Erro em /pdf-para-jpg:", str(e))
        return JSONResponse(content={"erro": str(e)}, status_code=500)
